...
// class UAEPage extends StatefulWidget {
//   const UAEPage({super.key});

//   @override
//   _GoldPriceWidgetState createState() => _GoldPriceWidgetState();
// }

// class _GoldPriceWidgetState extends State<UAEPage> {
...
//             gradient: LinearGradient(
//               colors: [
//                 Color.fromARGB(255, 72, 139, 4),
//                 Color.fromARGB(255, 204, 205, 202),
//                 Color.fromARGB(255, 21, 19, 18)
//               ],
...
class SliverPrice {
  ...
  Future<void> fetchSliverPrice() async {
    final Dio dio = Dio();
    final response = await dio.get(
      'https://www.goldapi.io/api/XAG/AED',
      options: Options(
        headers: {
          'x-access-token': 'goldapi-1esnb5ksm1oxup7b-io',
        },
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('فشل في جلب سعر الفضة');
    }
  }
}
