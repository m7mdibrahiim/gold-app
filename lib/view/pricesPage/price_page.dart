...
import 'package:gold/view/countries/soudi_page.dart';
      ...
      child: Scaffold(
          ...
          flexibleSpace: Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [Colors.amber, Color.fromARGB(255, 228, 139, 5)],
        ...
        body: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              colors: [
                Color.fromARGB(255, 78, 76, 71),
                Color.fromARGB(255, 243, 153, 27)
              ],
...
class SliverPrice {
  ...
  Future<void> fetchSliverPrice() async {
    final Dio dio = Dio();
    final response = await dio.get(
      'https://www.goldapi.io/api/XAG/EGP',
      options: Options(
        headers: {
          'x-access-token': 'goldapi-1esnb5ksm1oxup7b-io',
        },
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('أسعار الذهب'),
//         backgroundColor: Colors.amber[700],
//       ),
//       body: Consumer<GoldPriceProvider>(
//         builder: (context, goldPriceProvider, child) {
//           if (goldPriceProvider.isLoading) {
//             return Center(child: CircularProgressIndicator());
//           }

//           return goldPriceProvider.timestamp != null
//               ? RefreshIndicator(
//                   onRefresh: goldPriceProvider.fetchGoldPrice,
//                   child: ListView(
...
//                         context: context,
//                         title: 'عيار 24',
//                         salePrice: goldPriceProvider.pricePerGram24sale ?? 0,
//                         buyPrice: goldPriceProvider.pricePerGram24buy ?? 0,
//                       ),
//                       _buildGoldCard(
//                         context: context,
//                         title: 'عيار 22',
//                         salePrice: goldPriceProvider.pricePerGram22sale ?? 0,
//                         buyPrice: goldPriceProvider.pricePerGram24buy ?? 0,
//                       ),
//                       _buildGoldCard(
//                         context: context,
//                         title: 'عيار 21',
//                         salePrice: goldPriceProvider.pricePerGram21sale ?? 0,
//                         buyPrice: goldPriceProvider.pricePerGram24buy ?? 0,
//                       ),
//                       _buildGoldCard(
//                         context: context,
//                         title: 'عيار 18',
//                         salePrice: goldPriceProvider.pricePerGram18sale ?? 0,
//                         buyPrice: goldPriceProvider.pricePerGram24buy ?? 0,
//                       ),
//                       _buildGoldPriceInfoCard(),
//                       SizedBox(height: 16),
//                       Text(
//                         'آخر تحديث: ${DateFormat('yyyy-MM-dd – kk:mm').format(DateTime.fromMillisecondsSinceEpoch(goldPriceProvider.timestamp! * 1000))}',
...
//       ),
//       floatingActionButton: FloatingActionButton(
//         onPressed: () => context.read<GoldPriceProvider>().fetchGoldPrice(),
//         backgroundColor: Colors.amber[700],
...
//               children: [
//                 Text(
//                   'سعر البيع: ${salePrice.toStringAsFixed(2)} جنيها',
//                   style: TextStyle(fontSize: 18, color: Colors.grey[200]),
//                 ),
//                 Text(
//                   'سعر الشراء: ${buyPrice.toStringAsFixed(2)} جنيها',
//                   style: TextStyle(fontSize: 18, color: Colors.grey[200]),
//                 ),
//               ],
//             ),
...
//             SizedBox(height: 8),
//             Text(
//               'تتغير أسعار الذهب بناءً على السوق العالمي والتغيرات السياسية والاقتصادية، يُنصح بالتحقق من الأسعار قبل الشراء أو البيع.',
